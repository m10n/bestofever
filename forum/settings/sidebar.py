...
u"""
## [Host OSQA in the Cloud] [1]

Host your own OSQA environment in the cloud for free using  [**BitNami Cloud Hosting**][1] and the Amazon Cloud Free tier.

[1]: http://bitnami.com/cloud?utm_source=bitnami&utm_medium=application&utm_campaign=osqa
""", SIDEBAR_SET, dict(
